...
CREATE DATABASE IF NOT EXISTS jpj_20260917_152407_7272aa;
USE jpj_20260917_152407_7272aa;
...
STORED AS TEXTFILE
LOCATION '/warehouse/jpj/runs/20260917_152407_7272aa/curated'
...
PARTITIONED BY (registration_year INT, registration_month INT)
STORED AS ORC
LOCATION '/warehouse/jpj/runs/20260917_152407_7272aa/dwd'
...
PARTITIONED BY (registration_year INT, registration_month INT)
STORED AS ORC
LOCATION '/warehouse/jpj/runs/20260917_152407_7272aa/ads'
TBLPROPERTIES ('orc.compress'='SNAPPY', 'transactional'='false');
...
INSERT OVERWRITE DIRECTORY '/warehouse/jpj/runs/20260917_152407_7272aa/results/aggregates'
ROW FORMAT DELIMITED FIELDS TERMINATED BY '\t'
STORED AS TEXTFILE
...
INSERT OVERWRITE DIRECTORY '/warehouse/jpj/runs/20260917_152407_7272aa/results/checks'
ROW FORMAT DELIMITED FIELDS TERMINATED BY '\t'
STORED AS TEXTFILE
